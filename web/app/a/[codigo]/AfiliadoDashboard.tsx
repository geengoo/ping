...
interface Props {
  ...
  conversoes: { criadoEm: string; produtoNome: string; nomeConvidado: string | null; emailConvidado: string; valorCentavos: number; status: string }[]
    ...
    <main className="min-h-screen bg-[#f8f9fa]">
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-5">
        ...
        <div>
          ...
          {saldo.pendente > 0 && (
            <p className="text-xs text-yellow-600 mt-2">Aguardando o período de desistência para liberar o saldo.</p>
          )}
        </div>
